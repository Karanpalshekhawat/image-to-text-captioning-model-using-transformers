...
with gr.Blocks() as demo:
    with gr.Row():
        query = gr.Textbox(label="Query", placeholder="Describe the image that you want to download in 3-4 words")
    ...
    with gr.Column():
        gallery = gr.Gallery(label="Captioning Generated Images", show_label=True, elem_id="gallery",
                             object_fit="contain")
